...
Nova.booting(function (Vue, router) {
    ...
    Vue.component('custom-create-header', __webpack_require__(3));
    Vue.component('templates-create-header', __webpack_require__(6));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    component: function component() {
      return this.resourceName + '-create-header';
    },
...
Component.options.__file = "resources/js/components/TemplatesDetailToolbar.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-fef6d248", Component.options)
  } else {
    hotAPI.reload("data-v-fef6d248", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    zozo: function zozo() {
      console.log("coucou", this.resource, this.resourceName, this.field);
    }
  }
});
    ...
    _c("div", { staticClass: "flex w-full justify-end items-center" }, [
      _c(
        "a",
        {
          ...
          attrs: {
            href:
              "/nova-vendor/custom-resource-toolbar/export-quote/" +
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-fef6d248", module.exports)
  }
}
