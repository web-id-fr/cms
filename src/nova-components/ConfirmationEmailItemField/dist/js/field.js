...
Nova.booting(function (Vue) {
  Vue.component('index-confirmation-email-item-field', __webpack_require__(3));
  Vue.component('detail-confirmation-email-item-field', __webpack_require__(6));
  Vue.component('form-confirmation-email-item-field', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        tutu: function tutu() {
            var fieldType = this.field.fieldTypeEmail;
            var options = [];
