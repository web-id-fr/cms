...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SelectMenu__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SelectMenu___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__SelectMenu__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_toasted__ = __webpack_require__(19);
...
__WEBPACK_IMPORTED_MODULE_1_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_2_vue_toasted___default.a);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        'select-menu': __WEBPACK_IMPORTED_MODULE_0__SelectMenu___default.a
    },
    ...
    methods: {
        getMenus: function getMenus() {
            ...
            Nova.request().get('/ajax/menu').then(function (response) {
                _this.menus = response.data.data;

                _.forIn(_this.menus, function (item) {
                    _.forIn(item.zones, function (zone) {
                        _this.menusZones[zone] = item.id;
                    });
                });
            }).catch(function (error) {
                console.log(error.response);
                _this.showToast('An error occured while attempting to get available menus.');
            });
        },
        getMenusZones: function getMenusZones() {
            var _this2 = this;

            Nova.request().get('/ajax/menuconfiguration').then(function (response) {
                var zones = response.data;

                _.forIn(zones, function (item) {
                    if (typeof _this2.menusZones[item.menuID] == "undefined") {
                        _this2.menusZones[item.menuID] = null;
                    }
                });
                ...
                console.log(error.response);
                _this2.showToast('An error occured while attempting to get menus zones.');
            }).finally(function () {
                // Une fois qu'on a récupéré les zones, on récupère les menus
                _this2.getMenus();
            });
        },
        updateSelectedMenu: function updateSelectedMenu(menuID, newSelection) {
        ...
        updateMenu: function updateMenu(url, data) {
            var _this3 = this;
            ...
            Nova.request().post(url, {
                ...
                _this3.showToast(response.data.message, 'The menu was successfully updated.');
            }).catch(function (error) {
                console.log(error.response);
                _this3.showToast();
            });
        },
        isInvalidData: function isInvalidData(data) {
            return data === null || Array.isArray(data) && data.length === 0;
        },
        showToast: function showToast(message) {
            var defaultMessage = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'An unexpected error occured.';

            __WEBPACK_IMPORTED_MODULE_1_vue___default.a.toasted.show(message || defaultMessage, {
                duration: 6000,
...
Component.options.__file = "resources/js/components/SelectMenu.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-bf3050b4", Component.options)
  } else {
    hotAPI.reload("data-v-bf3050b4", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
            ...
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.menu_selected,
                expression: "menu_selected"
              }
            ],
            ...
            on: {
              change: [
                function($event) {
                  ...
                  _vm.menu_selected = $event.target.multiple
                    ? $$selectedVal
                    : $$selectedVal[0]
                },
                _vm.updateSelectedMenu
              ]
            }
          },
          [
            ...
            _vm._l(_vm.menus, function(menu) {
              return _c(
                "option",
                {
                  domProps: {
                    value: menu.id,
                    selected: menu.id === _vm.menu_selected
                  }
                },
                [
                  _vm._v(
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-bf3050b4", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Configuration")]),
      _vm._v(" "),
      _c(
        "card",
        { staticClass: "flex px-8", staticStyle: { "min-height": "300px" } },
        [
          _c(
            "form",
            { staticStyle: { width: "100%" }, attrs: { autocomplete: "off" } },
            _vm._l(_vm.zones, function(zone) {
              return _c("select-menu", {
                key: zone.menuID,
                attrs: {
                  menus: _vm.menus,
                  value: _vm.menusZones[zone.menuID],
                  label: zone.label
                },
                on: {
                  updateSelectedMenu: function($event) {
                    return _vm.updateSelectedMenu($event, zone)
                  }
                }
              })
            }),
